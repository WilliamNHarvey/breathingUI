      ...
      .controller('technicianManageController', function($rootScope, $scope, $location, $window, $compile, LS, userService) {
          ...
          userService.checkSession().then(function(res) {
              if(!res) {
                  ...
                  $scope.user = res.data.user;
                  if($scope.user.job !== "technician") {
                      $location.path("/");
                  }
                  $scope.datasets = JSON.parse(LS.getData("storedData")) || [];
                  /*$scope.datasets.push({
                  ...
                  $.each($scope.datasets, function(n, v) {
                      if(v.tech && $scope.user.email === v.tech) {
                          eegSets.push(v.eeg);
                          barSets.push(v.bar);
                      }
                      else {
                  ...
                  angular.forEach($scope.datasets, function(val, key) {
